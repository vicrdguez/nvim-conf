  ...
  highlight_overrides = {
    all = function(colors)
      return {
        ...
        MiniStatuslineModeNormal = { bg = colors.flamingo, fg = colors.surface0 },
        MiniStatuslineModeInsert = { bg = colors.teal },
        MiniStatuslineModeVisual = { bg = colors.blue },
        MiniStatuslineModeReplace = { bg = colors.red },
        MiniStatuslineModeCommand = { bg = colors.pink },
